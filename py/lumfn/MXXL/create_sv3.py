...
names = ['MOCKRA', 'MOCKDEC', 'Z', 'ZOBS', 'MRH', 'RMAG_DRED', 'REFGMR0P1', 'GTYPE', 'HMASS', 'NMOCK', 'HALOID']
data  = Table(np.c_[ra[isin], dec[isin], z[isin], zobs[isin], M[isin], r[isin], gmr[isin], tt[isin], hmass[isin], nmock[isin], mxxlid[isin]], names=names) 
